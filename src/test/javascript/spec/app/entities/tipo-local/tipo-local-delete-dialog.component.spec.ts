...
import { TipoLocalDeleteDialogComponent } from 'app/entities/tipo-local/tipo-local-delete-dialog.component';
import { TipoLocalService } from 'app/entities/tipo-local/tipo-local.service';

describe('Component Tests', () => {
  describe('TipoLocal Management Delete Component', () => {
    let comp: TipoLocalDeleteDialogComponent;
    let fixture: ComponentFixture<TipoLocalDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .compileComponents();
      fixture = TestBed.createComponent(TipoLocalDeleteDialogComponent);
