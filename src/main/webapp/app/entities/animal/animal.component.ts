...
export class AnimalComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.animalService
      ...
      .subscribe(
        (res: HttpResponse<IAnimal[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IAnimal[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
