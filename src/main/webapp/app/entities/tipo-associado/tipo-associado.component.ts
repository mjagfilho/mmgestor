...
export class TipoAssociadoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.tipoAssociadoService
      ...
      .subscribe(
        (res: HttpResponse<ITipoAssociado[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ITipoAssociado[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
