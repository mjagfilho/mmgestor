...
export class TipoLocalComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.tipoLocalService
      ...
      .subscribe(
        (res: HttpResponse<ITipoLocal[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ITipoLocal[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
