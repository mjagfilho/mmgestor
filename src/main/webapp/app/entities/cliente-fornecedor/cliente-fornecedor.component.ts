...
export class ClienteFornecedorComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.clienteFornecedorService
      ...
      .subscribe(
        (res: HttpResponse<IClienteFornecedor[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IClienteFornecedor[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
