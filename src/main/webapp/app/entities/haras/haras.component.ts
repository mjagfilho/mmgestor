...
export class HarasComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.harasService
      ...
      .subscribe(
        (res: HttpResponse<IHaras[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IHaras[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
