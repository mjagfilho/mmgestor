...
export class AssociadoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.associadoService
      ...
      .subscribe(
        (res: HttpResponse<IAssociado[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IAssociado[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
