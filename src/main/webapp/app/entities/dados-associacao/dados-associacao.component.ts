...
export class DadosAssociacaoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.dadosAssociacaoService
      ...
      .subscribe(
        (res: HttpResponse<IDadosAssociacao[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IDadosAssociacao[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
