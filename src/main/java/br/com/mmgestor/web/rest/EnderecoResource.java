...
/**
 * REST controller for managing {@link br.com.mmgestor.domain.Endereco}.
 */
@RestController
@RequestMapping("/api")
public class EnderecoResource {
     ...
     *         body the new endereco, or with status {@code 400 (Bad Request)} if
     ...
     *         the updated endereco, or with status {@code 400 (Bad Request)} if the
     *         endereco is not valid, or with status
     *         {@code 500 (Internal Server Error)} if the endereco couldn't be
     *         updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the endereco, or with status {@code 404 (Not Found)}.
     */
