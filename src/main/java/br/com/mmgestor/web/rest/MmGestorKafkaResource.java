...
@RestController
@RequestMapping("/api/mm-gestor-kafka")
public class MmGestorKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MmGestorKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MmGestorKafkaResource(KafkaProperties kafkaProperties) {
