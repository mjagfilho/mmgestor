...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .and()
            .contentSecurityPolicy("script-src 'unsafe-inline' 'sha256-+WlV8/ocn5lG4wb+FlH8DR0jf4xpq/V/Bdl/6wiEZpI=';")
            .and()
            ...
            .and()
            .contentSecurityPolicy("font-src https://use.typekit.net data:;")
            .and()
            ...
            .and()
            .contentSecurityPolicy("require-trusted-types-for 'script';")
        .and()
