...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            .headers()
            .contentSecurityPolicy("default-src 'self' https://www.mmgestor.com.br;")
            .and()
            .contentSecurityPolicy("script-src 'self' 'unsafe-inline' 'unsafe-eval' 'sha256-+WlV8/ocn5lG4wb+FlH8DR0jf4xpq/V/Bdl/6wiEZpI=';")
            .and()
            .contentSecurityPolicy("script-src-elem 'self' 'unsafe-inline';")
            .and()
            .contentSecurityPolicy("connect-src 'self' https://viacep.com.br;")
            .and()
            .contentSecurityPolicy("style-src 'self' 'unsafe-inline';")
            .and()
            .contentSecurityPolicy("img-src 'self' data:;")
            .and()
            .contentSecurityPolicy("font-src 'self' https://use.typekit.net data:;")
            .and()
            .contentSecurityPolicy("object-src 'none';")
            .and()
            .contentSecurityPolicy("frame-src 'self' data:;")
            .and()
            .contentSecurityPolicy("trusted-types default;")
        .and()
